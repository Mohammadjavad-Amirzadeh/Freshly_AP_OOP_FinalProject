...
public class EmailSender implements Runnable{
    ...
    private String text;
    public static int sendEmail(String GmailAddress, String text) throws MessagingException {
        ...
        message.setText(text); // متن ایمیل
    ...
    public void run() {
        try {
            sendEmail(GmailAddress,text);
        } catch (MessagingException e) {
            throw new RuntimeException(e);
        }
    }
    public EmailSender (String GmailAddress, String text){
