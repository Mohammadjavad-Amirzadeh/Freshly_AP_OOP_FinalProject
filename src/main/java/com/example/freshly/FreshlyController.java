...
public class FreshlyController implements Initializable {
    ...
    @FXML
    private Hyperlink BackToLoginPage1;

    @FXML
    private TextField CaptchTextfield;
    ...
    @FXML
    private Label RetrivalPasswordText1;
    ...
    @FXML
    private TextField VerificationٍEmailTextField1;

    @FXML
    private ImageView captcha0;

    @FXML
    private ImageView captcha1;

    @FXML
    private ImageView captcha10;

    @FXML
    private ImageView captcha11;

    @FXML
    private ImageView captcha12;

    @FXML
    private ImageView captcha2;

    @FXML
    private ImageView captcha3;

    @FXML
    private ImageView captcha4;

    @FXML
    private ImageView captcha5;

    @FXML
    private ImageView captcha6;

    @FXML
    private ImageView captcha7;

    @FXML
    private ImageView captcha8;

    @FXML
    private ImageView captcha9;
    ...
    private Boolean checkFieldsSignUpPane(){
        ...
        if (UsernameTextField.getText().isEmpty() ||
                ...
                EmailTextField.getText().isEmpty() || !CaptchaChecker.checkInputCaptcha(CaptchTextfield.getText(), rand)){
    ...
    public void setCaptchaImage(int input){
        captcha0.setVisible(false);
        captcha1.setVisible(false);
        captcha2.setVisible(false);
        captcha3.setVisible(false);
        captcha4.setVisible(false);
        captcha5.setVisible(false);
        captcha6.setVisible(false);
        captcha7.setVisible(false);
        captcha8.setVisible(false);
        captcha9.setVisible(false);
        captcha10.setVisible(false);
        captcha11.setVisible(false);
        captcha12.setVisible(false);
        if (input==100){
            captcha0.setVisible(true);
        }
        if (input==101){
            captcha1.setVisible(true);
        }
        if (input==102){
            captcha2.setVisible(true);
        }
        if (input==103){
            captcha3.setVisible(true);
        }
        if (input==104){
            captcha4.setVisible(true);
        }
        if (input==105){
            captcha5.setVisible(true);
        }
        if (input==106){
            captcha6.setVisible(true);
        }
        if (input==107){
            captcha7.setVisible(true);
        }
        if (input==108){
            captcha8.setVisible(true);
        }
        if (input==109){
            captcha9.setVisible(true);
        }
        if (input==110){
            captcha10.setVisible(true);
        }
        if (input==111){
            captcha11.setVisible(true);
        }
        if (input==112){
            captcha12.setVisible(true);
        }
    }
